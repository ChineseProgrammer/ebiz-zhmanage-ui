  ...
  methods: {
    ...
    modifyServiceApi() {
      ...
      let requestParam = {
        ...
        url: formData.url,
        flowRuleStatus: formData.flowRuleStatus,
        flowRuleGrade: formData.flowRuleGrade,
        flowRuleCount: formData.flowRuleCount,
        flowRuleControlBehavior: formData.flowRuleControlBehavior,
        flowRuleMaxQueueingTimeout: formData.flowRuleMaxQueueingTimeout,
        degradeRuleStatus: formData.degradeRuleStatus,
        degradeRuleGrade: formData.degradeRuleGrade,
        degradeRuleCount: formData.degradeRuleCount,
        degradeRuleTimeWindow: formData.degradeRuleTimeWindow
      };

      that.$api
        .service_api_modify(requestParam)
        .then(function(data) {
          if (data.respCode == 0) {
