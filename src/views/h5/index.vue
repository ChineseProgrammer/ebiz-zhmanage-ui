 ...
 */
 <template>
  ...
  <div id="app" :style="{ height: bodyHeight + 'px' }">
    ...
    <span class="index-img-title" v-if="isHidden"
      >我要预约</span
    >
...
export default {
  ...
  created() {
    ...
    }else if(window.location.href.indexOf("channel=") > 0||window.location.href.indexOf("&userid=") > 0){
