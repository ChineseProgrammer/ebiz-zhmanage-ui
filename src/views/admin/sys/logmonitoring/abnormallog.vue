    ...
    <div class="header">
      <div class="left">
        <Form ref="formInline" :model="params" inline :label-width="90">
          <FormItem prop="abnormalDate" label="异常时间">
...
export default {
  data() {
    return {
      ...
      tableList: [
       {
           abnormalDate:"2019/11/3 09:30:25",
           abnormal:"Error: ENOENT: no such file or directory",                    
       },
        {
           abnormalDate:"2019/11/3 09:13:23",
           abnormal:"Parsing error: x-invalid-end-tag (vue/no-parsing-error)",                       
       },
        {
           abnormalDate:"2019/11/3 09:15:33",
           abnormal:"操作数据库异常：SQLException",                      
       },
       {
           abnormalDate:"2019/11/3 13:30:33",
           abnormal:"输入输出异常：IOException",                       
       },
        {
           abnormalDate:"2019/11/3 09:33:40",
           abnormal:"方法未找到异常：NoSuchMethodException",                   
       },
