    ...
    <div class="header">
      <div class="left">
        <Form ref="formInline" :model="params" inline :label-width="90">
          <FormItem prop="loginDate" label="登录时间">
           <DatePicker type="date"  style="width: 200px"></DatePicker>
          </FormItem>
          <FormItem prop="loginName" label="登录人">
            <Input v-model="params.loginName" />
          </FormItem>
        </Form>
      </div>
      <div class="right">
        ...
        <!-- <Modal v-model="modalForm" title="新增登录日志" :draggable="false" :loading="true" :closable="false" :width="700">
            <Form ref="formValidate" :model="formData" :rules="ruleValidate" :label-width="100" label-position="left">
                <Row>
                    ...
                    <FormItem label="登录时间" prop="loginDate">
                       <DatePicker type="Date"  style="width: 200px"></DatePicker>
                    </FormItem>
                    <FormItem label="登录人" prop="loginName">
...
export default {
  data() {
    return {
      ...
      tableList: [
       {
           loginDate:"2019/11/3 09:02:25",
           loginName:"王倩",           
       },
        {
           loginDate:"2019/11/3 09:05:15",
           loginName:"张杰",           
       },
        {
           loginDate:"2019/11/3 09:07:25",
           loginName:"李建",           
       },
       {
           loginDate:"2019/11/3-09:10:25",
           loginName:"赵博",           
       },
        {
           loginDate:"2019/11/3 09:15:25",
           loginName:"赵思",           
       },
       {
           loginDate:"2019/11/3 09:20:15",
           loginName:"王冬",           
       },
      ],
      total: 0,
